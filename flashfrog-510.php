...
<html lang="en">
    ...
    <meta name="author" content="Solidforge">
        ...
        <style>
            ...
            .header-bg{
                background-image: url(images/dark-black-empty-pedestal-stand-product-promotion_1017-52779.jpg);
            ...
            .Product-bg{
                /* background-image: url(images/abstract-brown-gradient-well-used-as-background-product-display_1258-53817.jpg); */
                background: radial-gradient(circle, rgba(0,0,0,1) 0%, rgba(207,101,36,1) 0%, rgba(123,66,31,1) 25%, rgba(0,0,0,1) 57%);
                background-repeat: no-repeat;
                background-position: center;
                background-size: 106% 100%;
            }
            .brand-bg{
                background-image: url(images/gold-bangles-set.jpg);
                background-repeat: no-repeat;
                background-position: center;
                background-size: 106% 100%;
            }
            .technology-bg{
                background-image: url(images/illustration-dark-black-geometric-abstract.jpg);
                background-repeat: no-repeat;
                background-position: center;
                background-size: 100% 100%;
            }
            .moldless-bg{
                background-image: url(images/3d-printing-action-creating-complex-model_573056-38237.jpg);
                background-repeat: no-repeat;
                background-position: center;
                background-size: 100% 100%;
            }
    ...
    <body>
        ...
        <!-- header -->
        <header class="container-fluid header-bg pt-3 pt-md-5 position-relative">
            <img src="images/waxjet-510.png" alt="waxjet" class="position-absolute wax-jet-position">
            <div class="col-12 col-md-5 px-md-4 mx-auto text-white text-center">
                <h1 class="display-4 fw-semibold">WaxJet 510</h1>
                <p class="wax-jet-text fw-light">WaxJet 3D Printing Precision Perfected Born for K-Gold Jewelry Casting</p>
            </div>
        </header>
        ...
        <div class="container-fluid Product-bg py-5 ">
            ...
            <div class="d-flex justify-content-center mb-5">
                <div class="card bg-dark text-center text-warning p-2 p-md-4" style="width: 23rem;">
                    <h3>WaxJet 510</h3>
