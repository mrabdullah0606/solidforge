...
<div class="col-12">
  <h1 class="hero-title display-1 fw-bold text-center mt-4 mb-2">S3<span class="text-dark">Duo</span></h1>
  <p class="hero-subtitle fw-bold text-center mb-4 fs-2">Configure to your workflow</p>
</div>

<div class="col-12 col-md-10 col-lg-8 mx-auto">
  <img src="images/Solidscape-S3Duo-1000-800.avif" alt="S3Duo" class="img-fluid my-4">
</div>


<div class="col-12 d-flex justify-content-center flex-wrap gap-4 py-4">
  <button class="btn btn-dark btn-sm px-5 py-2">Explore more</button>
...
<div class="container-fluid p-0 overflow-hidden d-flex justify-content-center align-items-center" style="height: 100vh;">
  <!-- Background Video -->
  <video autoplay muted loop playsinline class="position-absolute w-100 h-100 object-fit-cover">
    <source src="images/S325.mp4" type="video/mp4">
  </video>

  <!-- Centered Text Overlay -->
  <div class="text-white text-center z-1">
    <h1 class="display-3 fw-bold">
      “For high-end jewelry, <br> everyone should have a Solidscape.”
    </h1>
    <p class="fs-4 mt-3">Sachin Shirke, Studio Devji Aurum</p>
  </div>
</div>
  ...
  <div class=" mx-0 row gx-3 justify-content-center">
    ...
    <div class="col-md-4 col-12 mb-4">
      <div class="card text-white text-center p-4 w-100 h-100 d-flex flex-column justify-content-between" style="background-color: black;">
        ...
        <div class="mt-auto">
          <button class="btn btn-light btn-sm px-5 py-2">Connect with an Expert</button>
    ...
    <div class="col-md-4 col-12 mb-4">
      <div class="card text-white text-center p-4 w-100 h-100 d-flex flex-column justify-content-between" style="background-color: black;">
        <div>
          ...
          <p class="fs-5 mt-3">Wash away supports within minutes. Washable supports present hands-free post-processing and allow for the finest of details to be printed without risk of damage.</p>
        </div>
        <div class="mt-auto">
    ...
    <div class="col-md-4 col-12 mb-4">
      <div class="card text-white text-center p-4 w-100 h-100 d-flex flex-column justify-content-between" style="background-color: black;">
        <div>
          ...
          <p class="fs-5 mt-3">No more guesswork. Solidscape prints 100% wax to provide a drop-in digital solution that can sit alongside hand-carved and injected waxes on the same tree.</p>
        </div>
        <div class="mt-auto">
          <button class="btn btn-light btn-sm px-5 py-2">Explore</button>
          <div class="mt-4" style="height: 260px;">
    <video class="img-fluid rounded h-100 w-100 object-fit-cover " autoplay loop muted playsinline>
...
<div class="container-fluid py-5" style="background-color: black;">
  <div class=" mx-0 row justify-content-center text-center text-white">
    <div class="col-lg-8">
      <h1 class="display-4 fw-bold">Smooth Curvature Printing™</h1>
      <p class="fs-4 mt-3">
        Our wax printers dynamically adjust carriage velocity to sustain continuous motion, 
        producing the highest precision and surface finish in the industry.
      </p>
    </div>
  </div>
</div>

<div class="container-fluid my-5 mb-4">
  <div class=" mx-0 row gx-3 justify-content-center">
  
    <div class="col-md-4 col-12">
      <div class="card text-white text-center p-4 w-100 h-100 d-flex flex-column justify-content-between" style="background-color: black;">
        <div>
          <h1 class="display-4 fw-bold">Mix-and-Match</h1>
          <p class="fs-5 mt-3">Add Solidscape waxes to the same tree with injected or hand-carved waxes for trouble-free casting.</p>
        </div>
        <div class="mt-auto">
          <button class="btn btn-light btn-sm px-5 py-2">Speak to an Expert</button>
          <div class="mt-4">
        <img src="images\img-1.png" alt="Modelworks Image" class="img-fluid rounded">
      </div>
        </div>
      </div>
    </div>
  ...
  <div class="card text-white text-center p-4 w-100 h-100 d-flex flex-column justify-content-between" style="background-color: black;">
    <div>
      ...
      <p class="fs-5 mt-3">Our materials are wax and you can handle them glove-free for ease of processing and safe material handling.</p>
    </div>
    <div class="mt-auto">
    ...
    <div class="col-md-4 col-12 mb-4">
      <div class="card text-white text-center p-4 w-100 h-100 d-flex flex-column justify-content-between" style="background-color: black;">
        <div>
          <h1 class="display-4 fw-bold">Automatic Software</h1>
          <p class="fs-5 mt-3">We provide automatic supports and set-up in the same way we provide automatic support removal.</p>
        </div>
        <div class="mt-auto">
          <button class="btn btn-light btn-sm px-5 py-2">Explore Modelworks</button>
          <div class="mt-4">
        <img src="images\img-2.png" alt="Modelworks Image" class="img-fluid rounded">
      </div>
        </div>
      </div>
    </div>
...
<div class="py-5 text-center py-4" style="background-color: black; color:white;">
  <h2 class=" display-4 fw-bold mb-4">S3Duo Specs</h2>
  <div class="container">
    <div class="table-responsive">
      <table class="table table-bordered spec-table border-top border-bottom">
        <thead>
          <tr class="spec-header">
          <th>Product specification</th>
          <th>S3Duo Advanced</th>
         <th>S3Duo with Solidjet</th>
  </tr>
</thead>
        ...
        <tbody>
          <tr>
            ...
            <td>User Selectable - 0.00025 inch (0.00635 mm) to 0.002 inch (0.051 mm) at 0.125 mil (0.003 mm) increments</td>
            <td>User Selectable - 0.001 inch (0.0254 mm) to 0.002 inch (0.0508 mm) at 0.00025 mm</td>
          </tr>
          <tr>
            <td>Speed Mode</td>
            <td>Optional speed mode from 0.001 inch (0.025 mm) to 0.002 inch (0.051 mm) available for the Advanced version</td>
            <td>Maximum print speed thanks to Solidjet technology</td>
          </tr>
          <tr>
            <td>Build Size</td>
            <td colspan="2">6 x 6 x 4 inches (152.4 x 152.4 x 101.6 mm)</td>
          </tr>
          <tr>
            <td>Resolution</td>
...
<div class="container py-4 d-flex flex-column justify-content-center align-items-center vh-80 text-center">
    <h1 class="display-5 fw-bold">
      What are you waiting for? <br>Start 3D printing in wax!
    </h1>

    <div class="col-12 d-flex justify-content-center flex-wrap gap-4 py-4">
      <button class="btn btn-dark btn-sm px-5 py-2">S3Duo Brochure</button>
